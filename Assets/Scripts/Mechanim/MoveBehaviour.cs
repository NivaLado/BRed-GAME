...
public class MoveBehaviour : GenericBehaviour
{
    ...
    public bool mouseRotationEnabled = true;        // Mouse Rotation Trigger
    ...
    void FallingManagment()
    {
        if (behaviourManager.DistanceToGround() == 0)
        {
            behaviourManager.GetAnim.SetBool(fallingBool, true);
        }
        else
        {
            behaviourManager.GetAnim.SetBool(fallingBool, false);
        }
    }
